...
public class login extends JFrame {
    ...
    JButton btnSubmit;
    JLabel lblUserName, lblPassword, lblOrganizationName, lblorganizationAddress, lblConfirmPassword;
    ...
    private JPanel Form(){
        ...
        lblOrganizationName.setFont(new Font("",Font.BOLD,25));
        txtRestaurantName = new JTextField();

        lblorganizationAddress = new JLabel("Organization Address:");
        lblorganizationAddress.setFont(new Font("",Font.BOLD,25));
        ...
        formPanel.add(lblOrganizationName);
        formPanel.add(txtRestaurantName);
        formPanel.add(lblorganizationAddress);
